...
#define ACCEL_SCL_Pin LL_GPIO_PIN_9
#define ACCEL_SCL_GPIO_Port GPIOA
#define ACCEL_PULL_UP_Pin LL_GPIO_PIN_9
#define ACCEL_PULL_UP_GPIO_Port GPIOD
#define SWDIO_Pin LL_GPIO_PIN_13
#define SWDIO_GPIO_Port GPIOA
#define SWCLK_Pin LL_GPIO_PIN_14
#define SWCLK_GPIO_Port GPIOA
#define VRTC_Pin LL_GPIO_PIN_9
#define VRTC_GPIO_Port GPIOC
#define VCC_GSM_DIS_Pin LL_GPIO_PIN_4
#define VCC_GSM_DIS_GPIO_Port GPIOD
#define PPS_Pin LL_GPIO_PIN_3
#define PPS_GPIO_Port GPIOB
#define PWR_GPS_EN_Pin LL_GPIO_PIN_5
#define PWR_GPS_EN_GPIO_Port GPIOB
#define CPU_TX_GPS_RX_Pin LL_GPIO_PIN_6
#define CPU_TX_GPS_RX_GPIO_Port GPIOB
#define CPU_RX_GPS_TX_Pin LL_GPIO_PIN_7
#define CPU_RX_GPS_TX_GPIO_Port GPIOB
#define CPU_RX_GSM_TX_Pin LL_GPIO_PIN_9
#define CPU_RX_GSM_TX_GPIO_Port GPIOB
#define CPU_TX_GSM_RX_Pin LL_GPIO_PIN_10
